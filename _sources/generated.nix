...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "11065";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b11065/llama-b11065-bin-macos-arm64.tar.gz";
      sha256 = "sha256-Nz7BZuH0Cks74dpsmidloBGVgW+ruGmFESm6nAI5PUo=";
    };
  };
  mise-aarch64-darwin = {
