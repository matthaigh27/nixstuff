...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10653";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10653/llama-b10653-bin-macos-arm64.tar.gz";
      sha256 = "sha256-ih0wUMg69Qnczg/y90fPIKeitvcVByLNqFHX8vu2z14=";
    };
  };
  mise-aarch64-darwin = {
