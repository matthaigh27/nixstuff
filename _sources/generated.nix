...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10835";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10835/llama-b10835-bin-macos-arm64.tar.gz";
      sha256 = "sha256-gMMq3rrf3mp1kcGYJf9XMggqj/N8fl74k+uf7g/06Ys=";
    };
  };
  mise-aarch64-darwin = {
