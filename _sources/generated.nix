...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10900";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10900/llama-b10900-bin-macos-arm64.tar.gz";
      sha256 = "sha256-VWU++5jJCznSbP6kA/micNNk/LqMRxQAboKhsCZZSNA=";
    };
  };
  mise-aarch64-darwin = {
