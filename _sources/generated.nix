...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10051";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10051/llama-b10051-bin-macos-arm64.tar.gz";
      sha256 = "sha256-IRpjnL6KUoFYjM8lC503imfaMRy6bfWX8DjGjM5VIJY=";
    };
  };
  mise-aarch64-darwin = {
