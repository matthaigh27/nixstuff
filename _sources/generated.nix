...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10435";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10435/llama-b10435-bin-macos-arm64.tar.gz";
      sha256 = "sha256-6+QmnOUgkUvISdDT+wRZaf1CAcaX0RfpkzLAYxxPoVk=";
    };
  };
  mise-aarch64-darwin = {
