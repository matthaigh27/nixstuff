...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10447";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10447/llama-b10447-bin-macos-arm64.tar.gz";
      sha256 = "sha256-Jr7Jt+gkuGVBCk2Oxkk9cXJ3ziR+foPMLEKXA2P4oiI=";
    };
  };
  mise-aarch64-darwin = {
