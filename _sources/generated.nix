...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10679";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10679/llama-b10679-bin-macos-arm64.tar.gz";
      sha256 = "sha256-5ZdhscvwZp5bBu6llOVjqo3zKZZ+QI1t63+Dsw7ccVA=";
    };
  };
  mise-aarch64-darwin = {
