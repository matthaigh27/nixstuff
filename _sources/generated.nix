...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10290";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10290/llama-b10290-bin-macos-arm64.tar.gz";
      sha256 = "sha256-0lsyo6NOEKQgnrb89TmOgg1lHyJk5fOndf2UHCsuQZw=";
    };
  };
  mise-aarch64-darwin = {
