...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10766";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10766/llama-b10766-bin-macos-arm64.tar.gz";
      sha256 = "sha256-30KMOeGdWOv57+KDorWzP2En0LIaK7ydkyIumMSzSTI=";
    };
  };
  mise-aarch64-darwin = {
