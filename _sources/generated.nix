...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10333";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10333/llama-b10333-bin-macos-arm64.tar.gz";
      sha256 = "sha256-5dZ8UmQQfjwU078q7jSTZbsrha6Zuwd6DLl0ocTCdBo=";
    };
  };
  mise-aarch64-darwin = {
