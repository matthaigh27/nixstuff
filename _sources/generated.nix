...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "11177";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b11177/llama-b11177-bin-macos-arm64.tar.gz";
      sha256 = "sha256-gV+PPdyPV863kv7VYb1qbGvVkFePOtOGBOf3DEneGsE=";
    };
  };
  mise-aarch64-darwin = {
