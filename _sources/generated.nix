...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10729";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10729/llama-b10729-bin-macos-arm64.tar.gz";
      sha256 = "sha256-Wbvsmnyf1vDHj8EIpF3xi71BWjbC3RCzkNhQLoZTrd8=";
    };
  };
  mise-aarch64-darwin = {
