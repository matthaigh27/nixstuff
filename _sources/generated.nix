...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10976";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10976/llama-b10976-bin-macos-arm64.tar.gz";
      sha256 = "sha256-qFyVym9ao4wy+K1HDborZg6GHwWjDWgbd+K747svXas=";
    };
  };
  mise-aarch64-darwin = {
