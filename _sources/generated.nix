...
}:
{
  ...
  llama-cpp-aarch64-darwin = {
    ...
    version = "10850";
    src = fetchurl {
      url = "https://github.com/ggml-org/llama.cpp/releases/download/b10850/llama-b10850-bin-macos-arm64.tar.gz";
      sha256 = "sha256-y4V+gsvdabZ87DKdGq7rBRXoNaL4sVYQ/ZQACL396Kg=";
    };
  };
  mise-aarch64-darwin = {
